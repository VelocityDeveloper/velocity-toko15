...
{
    echo '<div class="px-2">';
    echo '<div class="card rounded-0 shadow border-0 p-2 container mx-auto">';
    require_once(get_stylesheet_directory() . '/inc/part-header.php');
}
        ...
        <div class="card h-100 card-product p-2 overflow-hidden">
            ...
            <div class="card-body text-center position-relative p-0">
                ...
                <div class="p-3 text-center">
                    <?php
                    if (is_singular('product')) :
                        echo '<div class="py-1"><a class="btn btn-primary text-white fw-bold bg-colortheme text-uppercase" href="' . get_the_permalink() . '"><small>Detail</small></a></div>';
                    else :
                        echo '<div class="py-1">' . do_shortcode('[beli class="w-100 btn btn-primary text-white fw-bold bg-colortheme" button-text="Tambah Keranjang" modal="false" node-cart="cartsingle" text="true"]') . '</div>';
                        echo '<div class="py-1">' . do_shortcode('[beli-whatsapp pesan="' . get_the_title() . '"]') . '</div>';
                    endif;
                    ?>
                </div>
            </div>
        ...
        <div class="block-primary">
            ...
            <div class="row">
                ...
                <div class="col-md">
                    ...
                    <div class="mb-3"><?php echo do_shortcode('[beli class="w-100 btn btn-dark text-white fw-bold bg-colortheme" button-text="Tambah Keranjang" modal="false" node-cart="cartsingle" text="true"]'); ?></div>
                    <div class="mb-3"><?php echo do_shortcode('[beli-whatsapp class="btn btn-sm btn-success w-100 fw-bold" pesan="' . get_the_title() . '"]'); ?></div>
